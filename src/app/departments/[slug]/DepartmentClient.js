    ...
    <div className="dp-layout">
      ...
      <style jsx>{`
        ...
        .dp-card:hover {
          ...
          box-shadow: 0 28px 80px rgba(15, 110, 86, 0.15);
        ...
        .dp-action-btn-liquid {
          ...
          margin-top: auto;
          transition: all 0.4s cubic-bezier(0.34, 1.56, 0.64, 1);
          box-shadow: 0 12px 32px rgba(15, 110, 86, 0.2);
          position: relative;
          overflow: hidden;
          letter-spacing: 0.3px;
        }
        ...
        .dp-action-btn-liquid:hover {
          ...
          box-shadow: 0 20px 48px rgba(15, 110, 86, 0.35);
          background: linear-gradient(135deg, #085041, #062d22);
          border-color: #0F6E56;
        }
